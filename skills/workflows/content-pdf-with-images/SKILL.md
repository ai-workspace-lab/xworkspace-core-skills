...
Before generating, extending, repairing, or repainting chapter images, read [../../marketplace/pptx/editable-reconstruction.md](../../marketplace/pptx/editable-reconstruction.md) and apply its provider order, text-free generation, and residue QA rules. Generated chapter images must contain no titles, labels, numbers, watermarks, or pseudo-text. Keep all article text and captions in the PDF layout layer.
